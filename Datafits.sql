...
--
-- Host: localhost
-- Generation Time: Aug 31, 2023 at 08:23 AM
...
-- Database: `datafits`
--
CREATE DATABASE IF NOT EXISTS `datafits` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `datafits`;
...
('rp39mop1hsrekba1kygjs95u7vdtbu7n', 'eyJ1c2VyaWQiOjF9:1qZWO7:r7zED0-Mw0SXn8gGBOIGh5DKUPXCRmsFZudvFT_Mfng', '2023-09-08 12:58:07.700731'),
...
('x2uoc9xr9l4dqe6zyv9aagjp3tyabk1h', 'eyJ1c2VyaWQiOjJ9:1qZXNo:BFsP7oVsG39ftBYqJuo0ICiDF5un4wt0Jxu7tkUYC2g', '2023-09-08 14:01:52.498248'),
...
(1, 'Ashok', 'Ashok123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8923,4th Cross,Rajajinagar', 'Male'),
...
(30, 'KNeighborsClassifier', '32.608695652173914'),
(31, 'Convolutional Neural Network(CNN)', '36.024844720496894'),
(32, 'SVM', '40.37267080745342'),
(33, 'Logistic Regression', '38.81987577639752'),
(34, 'Gradient Boosting Classifier', '39.44099378881988');
...
(48, 'Minor Injury', '50.0'),
(49, 'Death', '25.0'),
(50, 'Greviously Injured', '25.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_traffic_incident_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_traffic_incident_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `lat` varchar(3000) NOT NULL,
  `lng` varchar(3000) NOT NULL,
  `road_desc` varchar(3000) NOT NULL,
  `zip` varchar(3000) NOT NULL,
  `timeStamp` varchar(3000) NOT NULL,
  `twp` varchar(3000) NOT NULL,
  `addr` varchar(3000) NOT NULL,
  `traffic_status` varchar(3000) NOT NULL,
  `traffic_occured_by` varchar(3000) NOT NULL,
  `area_accident_occured` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_traffic_incident_prediction`
--

INSERT INTO `remote_user_traffic_incident_prediction` (`id`, `Fid`, `lat`, `lng`, `road_desc`, `zip`, `timeStamp`, `twp`, `addr`, `traffic_status`, `traffic_occured_by`, `area_accident_occured`, `Prediction`) VALUES
(1, '203.205.158.60-10.42.0.211-80-44252-6', '40.1741312', '-75.0984907', 'BYBERRY AVE & S WARMINSTER RD; UPPER MORELAND; 2022-12-10 @ 17:15:49;', '19040', '10-12-22 17:15', 'UPPER MORELAND', 'BYBERRY AVE & S WARMINSTER RD', 'Medium', 'Rollover', 'Office areas', 'Minor Injury'),
(2, '183.79.250.123-10.42.0.211-443-36972-6', '40.251492', '-75.6033497', 'CHERRYWOOD CT & DEAD END;  LOWER POTTSGROVE; Station 329; 2022-12-10 @ 16:56:52;', '19427', '10-12-22 16:56', 'LOWER POTTSGROVE', 'CHERRYWOOD CT & DEAD END', 'Medium', 'Rollover', ' Industrial areas', 'Death'),
(3, '10.42.0.42-106.39.169.66-57125-80-6', '40.1552833', '-75.2642296', 'PENLLYN BLUE BELL PIKE & VILLAGE CIR;  WHITPAIN; Station 385; 2022-12-10 @ 18:02:38;', '19422', '10-12-22 18:02', 'WHITPAIN', 'PENLLYN BLUE BELL PIKE & VILLAGE CIR', 'Medium', 'Vehicle with vehicle collision', 'Office areas', 'Greviously Injured'),
(4, '180.149.153.234-10.42.0.211-80-53928-6', '40.1330371', '-75.4084631', 'SHANNONDELL DR & SHANNONDELL BLVD;  LOWER PROVIDENCE; Station 322A; 2022-12-10 @ 19:12:13;', '19403', '10-12-22 19:12', 'LOWER PROVIDENCE', 'SHANNONDELL DR & SHANNONDELL BLVD', 'Medium', 'Vehicle with vehicle collision', 'Other', 'Minor Injury');
